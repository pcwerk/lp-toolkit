        ...
        <Dialog.Panel className="relative w-full max-w-5xl mx-auto rounded-lg bg-white p-12 shadow-xl">
            ...
            <div className="flex flex-col lg:flex-row">
              <div className="flex-1">
                ...
                {/* Temperature Slider */}
            <div className="mb-6">
              <label htmlFor="temperature-slider" className="block text-lg font-medium text-gray-700">
                Temperature
              </label>
              <input
                type="range"
                ...
                max="1"
                step="0.01"
                value="0.7"  // Hardcoded value
                onChange={() => {}}
                className="w-full h-2 bg-gray-200 rounded-lg  appearance-none cursor-pointer"
              />
              <div className="text-right text-sm text-gray-600">0.7</div>
            </div>
            {/* Token Limit Input */}
            <div className="mb-6">
              <label htmlFor="token-limit" className="block text-lg font-medium text-gray-700">
                Token Limit
              </label>
              <input
                type="number"
